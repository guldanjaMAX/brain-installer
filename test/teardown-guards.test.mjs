...
for (const name of ["brain-test-run-1", "brain-test-owner-ui", "test-scratch", "TEST-UPPER", "brain-test"]) {
...
for (const name of [
  ...
  "greatest-hits",
  "contest-results",
  "financial-brain-live-preview",
  "primary-brain-shadow",
  "client-live-brain",
  "brain-attestation",
]) {
...
assert.equal(protectedListMissing("client-live-brain"), false, "one name is a list");
assert.equal(protectedListMissing("client-live-brain,primary-brain-shadow"), false, "several names are a list");
