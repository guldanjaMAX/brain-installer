...
const expected = [
  ...
  "migrations/d1/0021_chunk_token_fit.sql",
  "migrations/d1/0022_durable_drain_pause.sql",
  "migrations/d1/0023_grants.sql",
  "migrations/d1/0024_zones.sql",
  ...
  "operations/legal-register.mjs",
  "operations/release-state.mjs",
  ...
  "worker/src/lib/recovery-page.js",
