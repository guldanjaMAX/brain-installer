   ...
   not include the name of the key this product generates for itself. */
{
  ...
  const mustRefuse = [
    [(["ADMIN_KE","Y=8f3a2b","1c9d4e5f","6a7b8c9d","0e1f2a3b","4c5d6e7f","8a"].join("")), "the admin key this product generates"],
    [(["BRAIN_KE","Y=1a2b3c","4d5e6f7a","8b9c0d1e","2f3a4b5c","6d7e8f9a","0b"].join("")), "the same key under its MCP name"],
    [(["client_s","ecret: \"","GOCSPX-8","fJ2kL9mN","0pQrS3tU","4vW5xY6z","\""].join("")), "a real client secret"],
    [(["webhook_","secret ="," whsec_1","a2b3c4d5","e6f7g8h9","i0j1k2l3","m4n5o6p"].join("")), "a real webhook secret"],
  ];
  ...
  const r = scan((["ADMIN_KE","Y=8f3a2b","1c9d4e5f","6a7b8c9d","0e1f2a3b","4c5d6e7f","8a"].join("")));
