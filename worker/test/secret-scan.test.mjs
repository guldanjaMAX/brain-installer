...
for (const [n, t] of [
  ["classic CF in doc", (["| Cloudf","lare API"," Token (","Read/D1)"," | FIXTU","RE0CFTOK","EN0SYNTH","ETIC0NOT","AREALKEY","001 |"].join(""))],
  ["CF env token", (["CLOUDFLA","RE_API_T","OKEN=FIX","TURE0CFT","OKEN0SYN","THETIC0N","OTAREALK","EY001"].join(""))],
  ["resend inner underscore", (["Bearer r","e_2QKY3k","yq_AbCdE","fGhIjKlM","nOpQrStU","vWx"].join(""))],
  ["postgres dsn", (["postgres","://postg","res.abc:","sup3rS3c","retPassw","0rd@aws-","1.pooler",".supabas","e.com:54","32/postg","res"].join(""))],
  ["query token", (["https://","esignatu","res.io/a","pi/contr","acts?tok","en=9f2b7","c4a1e8d3","600bc5a9","e2f7d4b1","c86"].join(""))],
  ["pem header alone", (["-----BEG","IN RSA P","RIVATE K","EY-----\n","MIIEow..","."].join(""))],
  ["anthropic", (["sk-ant-a","pi03-Xq7","fLm2pRtY","v9wBn4Kd","Zs8HjE6c","AuG1i"].join(""))],
  ["supabase pat", (["sbp_a1b2","c3d4e5f6","a7b8c9d0","e1f2a3b4","c5d6e7f8","a9b0"].join(""))],
  ["google key", (["AIzaSyD-","9tSrke72","PouQMnMX","-a7eZSW0","jkFMBWY"].join(""))],
  ["stripe whsec", (["whsec_Ab","CdEfGhIj","KlMnOpQr","StUvWxYz","012345"].join(""))],
  ["notion", (["ntn_1234","567890ab","cdefghij","klmnopqr","stuvwxyz","ABCDEF"].join(""))],
...
const s = (["sbp_a1b2","c3d4e5f6","a7b8c9d0","e1f2a3b4","c5d6e7f8","a9b0"].join(""));
chk("repeat 1", scan(s).verdict === CONFIRMED);
chk("repeat 2", scan(s).verdict === CONFIRMED);
chk("repeat 3", scan(s).verdict === CONFIRMED);

// redaction
const r = redact((["k=re_2QK","Y3kyq_Ab","CdEfGhIj","KlMnOpQr","StUvWx d","one"].join("")));
