-- 0024_zones — which documents a person may read, not just what they may do.
--
-- Schema 23 answered "the CPA may read but not delete". It could not answer
...
-- schema 23 shipped capabilities without scope, so widening nothing is the
